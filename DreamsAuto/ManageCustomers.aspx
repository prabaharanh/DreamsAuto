<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ManageCustomers.aspx.cs" Inherits="DreamsAuto.WebForm13" %>
    ...
    <table class="nav-justified">
        ...
        <tr>
            ...
            <td style="width: 398px">
                <asp:TextBox ID="txtCustomerFirstName" runat="server" OnTextChanged="TextBox1_TextChanged" Width="275px"></asp:TextBox>
            </td>
            <td>
